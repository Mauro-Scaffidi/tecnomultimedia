...
void contactStarted( FContact c) {
  ...
  if ((f1.getName() == "boxInvisible" && f2.getName() == "circulo" || f1.getName() == "circulo" && f2.getName() == "boxInvisible" || f1.getName() == "boxInvisible" && f2.getName() == "circulo" || f1.getName() == "circulo" && f2.getName() == "boxInvisible") && !invisibilidad && !power2) {
    invisibilidad = true;
    power2 = true;
  }
